...
This project is all about keeping the Canon X‑07 alive and kicking. Back in the early ’80s, this little portable computer gave people the chance to dive into BASIC and assembly programming.

What we’re doing here:

- Gathering code, tips, and tricks for programming the X‑07.
- Preserving old manuals and guides (most of them only exist in French).
- Sharing knowledge so today’s retro‑computing fans can enjoy the machine just like the original community did.
...
- Documentations/Ressources
  - [Wikipedia](https://fr.wikipedia.org/wiki/Canon_X-07)
  - [Abandonware listing](http://abandonlistings.free.fr/) - /!\ http, old
  ...
  - [GTELLO web page](http://gtello.free.fr/cx07_f.htm) - /!\ http, old
  - [Collection sasfepu](http://collection.sasfepu.free.fr/articles.php?lng=fr&pg=214&tconfig=0) - /!\ http, old
  - [Ketturi electronics](https://ketturi.kapsi.fi/projects/canon-x-07/canon-x-07-documentation/)
  - [ledudu](https://canonx07.ledudu.com/)
...
- Vidéos
  - [You Tube](https://www.youtube.com/results?search_query=canon+X-07) - query "canon X-07"
    - [Schraf:Maths-info](https://www.youtube.com/watch?v=v8pwcWLz5Yk)
