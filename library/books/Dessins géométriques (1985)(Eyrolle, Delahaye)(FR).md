...
1040 DATA 1000, 14,31, 10,30, 12,31, 10,32, 10,34, 11,34, 11,33, 10,33
...
1230 DATA 1000, 13,34, 15,35, 16,34, 16,33
1240 DATA 1000, 15,35, 15,34, 16,34, 15,34, 15,35
1250 DATA 1000, 24,12, 26,10, 19,5, 19,3
...
10 'OISEAUX-POISSONS
50 LPRINT CHR$(18): LPRINT"M0,-500": LPRINT"I": NP=480: PI=ATN(1)*4
1000 DATA 1000, 0,0, 2,0, 4,1, 4,2, 3,2, 2,3, 4,5, 4,6, 2,5, 2,6, -1,5, -2,3
1010 DATA -1,2, -2,2, -3,3, -4,3, -5,2, -4,2, 0,0
1020 DATA 1000, -5,2, -5,1, -7,-1, -6,-2, -5,-2, -5,-3, -2,-2, -2,-3, 0,-2
1030 DATA 1,-1, 2,-1, 3,-2, 4,-2, 3,-1, 4,1
1040 DATA 1000, 2,5, 0,4, 0,2
1050 DATA 1000, -2,1, -5,1, -4,-1, -3,0, -3,-1, -4,-1, -5,-2, 0,-2
1060 DATA 1000, -7,-1, -6,-1
1070 DATA 1000, -4,2.4, -4,2.7, -4.3,2.7, -4.3,2.4, -4,2.4
1080 DATA 1000, -5,0, -5.5,0, -5.5,0.5, -5,0.5, -5,0
1200 DATA 2000
2000 '
2100 READ A
2110 IF A=2000 THEN 2400
2120 IF A=1000 THEN B1=0: READ A
2130 READ B
2200 X%=INT(NP*(A+10)/15)
2210 Y%=INT(NP*(B+10)/15)
2300 IF B1=0 THEN B1=1: LPRINT"M";X%;",";Y%
2310 IF B1=1 THEN LPRINT"D";X%;",";Y%
2320 GOTO 2100
2400 REM
...
100 N=6
110 DIM A(N)
120 FOR I=0 TO N: A(I)=B: NEXT I
130 X0=NP/3: Y0=NP/2: A0=-PI/4*(N-2): L0=NP/SQR(2)^N
140 X1=X0: Y1=Y0: X2=X0: Y2=Y0
150 LPRINT"M": INT(X0);",";INT(Y0)
190 NN=2^N-1
200 FOR I=0 TO NN
210 IF I=0 THEN 300
215 II=I: J=0
220 IF (II MOD 2)=0 THEN II=II/2: J=J+1: GOTO 220
230 AA=(A(N-J)*2-1)*( ((II-1)/2 MOD 2)*2-1 )*PI/2
240 A0=A0+AA
300 X0=X1: Y0=Y1: X1=X2: Y1=Y2: X2=X2+L0*COS(A0): Y2=Y2+L0*SIN(A0)
310 LPRINT"D";INT((X0+3*X1)/4);",";INT((Y0+3*Y1)/4)
315 LPRINT"D";INT((X2+3*X1)/4);",";INT((Y2+3*Y1)/4)
330 NEXT I
1000 END
```
