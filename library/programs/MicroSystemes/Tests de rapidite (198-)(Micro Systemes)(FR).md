...
Les programmes de tests des machines par Micro Systèmes.

Il serait interressant de les compiler en un seul, avec pour les machine qui l'ont, la fonction Time.
