...
190 LPRINTUSING"Date d'Acquisition: &      &    Taux: ##.## % |";D$;TX/CF;
195 LPRINT[1,3]STRING$(79,45)
200 LPRINT"| Annees | Val.Net.Comp.Deb | Taux (en%) |     ";
210 LPRINT"Annuites     | Val.Net.Comp.Fin |";STRING$(79,45);" ";
220 FORI=1TON:LPRINT"|";STRING$(8,32);"|";STRING$(18,32);"|";STRING$(12,32);
230 LPRINT"|";STRING$(18,32);"|";STRING$(18,32);"|";:NEXT:LPRINTSTRING$(79,45);
