...
Programme surprise :
```basic
1 DEFINT A-Z: OUT 243,2: OUT 244,78: X=242: H=243
2 FOR Z=1 TO 400: N=ABS(N+RND(1)*8-4): OUT X,N: NEXT
3 OUT 242,0: OUT 243,0
4 FOR Z=1 TO 400: OUT X,RND(1)*150+80: NEXT
5 OUT 243,0: FOR L=0 TO 253 STEP 5: OUT X,L: OUT X,L-1: OUT X,L-1: OUT X,L-2: OUT X,L-2: NEXT
6 FOR L=1 TO 255 STEP 5: FOR K=255 TO L STEP -5: OUT X,K: NEXT: NEXT
7 FOR L=255 TO 0 STEP -1: OUT X,255-L: OUT X,L: NEXT
8 FOR K=1 TO 10: FOR L=1 TO 20: OUT X,5*L: NEXT: NEXT
9 FOR K=1 TO 10: FOR L=1 TO 20: OUT X,255-5*L: NEXT: NEXT
10 OUT X,0: OUT H,0: FOR A=1 TO 5: FOR L=0 TO 15: OUT H,L: FOR K=0 TO 10: NEXT: NEXT: NEXT
11 OUT H,0: FOR S=10 TO 255: FOR N=0 TO 4: FOR F=0 TO 255 STEP S: OUT X,F: NEXT: NEXT: NEXT
12 OUT H,0: FOR F=0 TO 255: OUT X,F: FOR K=0 TO 9: NEXT: NEXT
13 FOR L=0 TO 200: OUT H,RND(1)*15: OUT X, RND(1)*15: NEXT
14 OUT H,0: FOR L=0 TO 200: OUT X,RND(1)*100+I: NEXT
15 FOR N=0 TO 9: OUT X,255: FOR I=0 TO 29: NEXT: OUT X,20: FOR I=0 TO 29: NEXT: NEXT
16 FOR I=0 TO 5: FOR F=68 TO 87: OUT X,F: OUT X,255-F: NEXT: NEXT
```

NDR : à vérifier car scan médiocre.
...
```basic
5 REM "UTILITAIRE GRAPHIQUE"
10 CLS:LINE(21,6)-(97,5):LINE(97,17):LINE -(21,17):LINE -(21,5):BEEP 5,9
20 FOR J=0 TO 119 STEP 8.5:LINE(J,0)-(60,6):LINE(J,31)-(60,17):BEEP 10,2:NEXT
30 BEEP 20,9:FOR J=0TO 31 STEP 3 :LINE (0,J)-(21,11):LINE (119,J)-(97,11)
40 BEEP 50,2:NEXT:BEEP 20,9:FOR I=1 TO 3:LOCATE 4,I:PRINT " CLUB C7 !!!"
50 FOR J=1 TO 100 STEP 10:BEEP J,2:NEXT J:LOCATE 4,1:PRINT STRING$(12," ")
60 FOR J=1 TO 99:NEXT J,I:FOR J=100 TO 500 STEP 50:BEEP J,5:NEXT
70 LOCATE 5,1:PRINT "CANON X-07"
80 IF INKEY$="" THEN 80 ELSE CLS
90 REM "SUITE DU PROGRAMME"
```
...
```basic
5 REM "J.O"
10 CLS:FOR I=1 TO 3:CIRCLE (15*I,10),10:BEEP 1,5:NEXT
20 CIRCLE STEP(-8,10),10:CIRCLE STEP(-14,0),10
30 FOR I=1 TO 5:BEEP I*10,5
50 CIRCLE (65,5),I:CIRCLE (113,5),I
60 LOCATE 13,0:PRINT"1984":LOCATE 13,3:PRINT "J.O";
70 H$="      LOS ANGELES PRESENTE LES JEUX OLYMPIQUES D'ETE"
80 FOR L=1 TO LEN(H$)-5:LOCATE 12,2:PRINTMID$(H$,L,6):BEEP 50,3
90 FOR J=1 TO 30:NEXT J,L
100 FOR I=1 TO 4096:BEEP I,2:IF INKEY$=""THEN NEXT:GOTO100ELSE CLS
```
